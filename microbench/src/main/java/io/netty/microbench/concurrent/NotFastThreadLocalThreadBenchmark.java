...
public class NotFastThreadLocalThreadBenchmark extends AbstractMicrobenchmark {
    ...
    public NotFastThreadLocalThreadBenchmark() {
        super(true, true);
    }
    ...
    public void setup() {
        ...
        // create an ordered array of thread's ID which cause the maximum number of branches
