...
/**
 * The general {@link ByteBuf} contract, on heap buffers served by the event-loop arena. Every buffer is
 ...
 */
public class CycleArenaHeapByteBufTest extends AbstractByteBufTest {
    ...
    protected ByteBuf newBuffer(int capacity, int maxCapacity) {
        ...
        return ALLOCATOR.heapBuffer(capacity, maxCapacity);
    }
