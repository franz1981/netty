 ...
 */
final class PoolThreadFullCache extends PoolThreadCache {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(PoolThreadFullCache.class);
    ...
    PoolThreadFullCache(PoolArena<byte[]> heapArena, PoolArena<ByteBuffer> directArena,
    ...
    private static final class SubPageMemoryRegionCache<T> extends MemoryRegionCache<T> {
        ...
        protected void initBuf(
                ...
                PoolThreadFullCache threadCache) {
    ...
    private abstract static class MemoryRegionCache<T> {
        ...
        protected abstract void initBuf(PoolChunk<T> chunk, ByteBuffer nioBuffer, long handle,
                                        PooledByteBuf<T> buf, int reqCapacity, PoolThreadFullCache threadCache);
         ...
         */
        public final boolean allocate(PooledByteBuf<T> buf, int reqCapacity, PoolThreadFullCache threadCache) {
