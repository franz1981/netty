...
final class AdaptivePoolingAllocator {
    ...
    private AdaptiveByteBuf allocate(int size, int maxCapacity, Thread currentThread, AdaptiveByteBuf buf) {
        ...
        FastThreadLocal<Object> fastThreadLocalMagazines = this.cachedMagazines;
        if (fastThreadLocalMagazines != null && currentThread instanceof FastThreadLocalThread) {
            Object mag = fastThreadLocalMagazines.get();
            if (mag != NO_MAGAZINE) {
