...
final class HpackStaticTable {
    ...
    /*  8 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "200"),
    /*  9 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "204"),
    /* 10 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "206"),
    /* 11 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "304"),
    /* 12 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "400"),
    /* 13 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "404"),
    /* 14 */ newPseudoHeaderField(PseudoHeaderName.STATUS, "500"),
